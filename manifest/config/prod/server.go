...
func CreateServerConfig() config.ServerConfig {
	...
	return config.ServerConfig{
		...
		DecimalCricketRedis:         &config.RedisConfig{Address: decimalCricketRedisAddress, MinIdleConns: 20, PoolSize: 200},
		DecimalCricketRedisReadOnly: &config.RedisConfig{Address: decimalCricketRedisReadOnlyAddress, MinIdleConns: 20, PoolSize: 200},
